...
- [Cross-plugin lib sharing: resolved for real config needs](project_cross-plugin-lib-sharing-resolved-for-real-config-needs.md) — gh:branch-create / github-prs:pr-create need 2 real fields each; fixed via inline 2-field parse, not a bare cross-plugin Read (which cannot resolve)
