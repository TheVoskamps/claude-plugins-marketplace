...
description: Reads a PR, the issues it closes, and the surrounding codebase at the high reasoning tier, and emits a list of disprovable theorems for the review pipeline to fan out. Spawned by the sdlc:pr-review-pipeline skill; it posts nothing and writes nothing.
...
format are what you follow, start to finish. Nothing in this file adds
to or overrides it.
