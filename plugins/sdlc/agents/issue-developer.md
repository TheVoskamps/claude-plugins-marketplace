...
13. Report back: PR URL (or equivalent), the issue set the PR closes,
    ...
    and its test result. Name any dropped member and why. (Your
    worktree stays where it is until the run's terminal cleanup skill
    reclaims it; its path isn't something you need to surface.)
