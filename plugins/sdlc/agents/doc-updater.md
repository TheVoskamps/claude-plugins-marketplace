...
Run this only if your commit and push both succeeded — if either
failed, `git branch -D` would destroy the only copy of your work, so
stop and report the failure instead of proceeding to cleanup:
