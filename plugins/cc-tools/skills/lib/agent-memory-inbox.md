...
Durable lore's home is the repo's own documentation — the
destinations `skills/lib/agent-memory-grading.md` → "Where a transfer
lands" ranks — and the inbox is the hand-off that carries a run's
